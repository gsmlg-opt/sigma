...
This project is indexed by GitNexus as **ex_pi** (630 symbols, 690 relationships, 7 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
