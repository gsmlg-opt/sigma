defmodule Sigma.Coding.Hooks do
  @moduledoc """
  Public facade for the hook dispatch system.

  Usage:

      specs = Sigma.Coding.Hooks.Discovery.load(cwd)
      {outcome, warnings} = Sigma.Coding.Hooks.dispatch(:pre_tool_use, specs, ctx, event_data)
  ...
  alias Sigma.Coding.Hooks.Runner
