defmodule Sigma.Coding.Tool do
  @moduledoc """
  Defines the behaviour for tools in the Sigma system.
  ...
  """
  @type result :: %{
          required(:content) => [Sigma.Ai.Message.text_content() | Sigma.Ai.Message.image_content()],
  ...
  def execute(%Sigma.Coding.MCP.Tool{} = tool, tool_call_id, params, opts) do
    Sigma.Coding.MCP.call_tool(tool, tool_call_id, params, opts)
  end
end
