defmodule Sigma.Agent.Message do
  @moduledoc """
  Rich domain type for messages within the agent loop.

  Mirrors `Sigma.Ai.Message` but adds:
  ...
  @type t :: %__MODULE__{
          ...
          usage: Sigma.Ai.Message.usage() | nil,
          stop_reason: Sigma.Ai.Message.stop_reason() | nil,
