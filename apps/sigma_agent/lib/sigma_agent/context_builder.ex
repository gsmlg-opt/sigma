defmodule Sigma.Agent.ContextBuilder do
  @moduledoc """
  ...
  user message by `Sigma.Agent.SessionContext`.
  """

  alias Sigma.Agent.MessageTransformer
  alias Sigma.Agent.SessionContext

  @cache_control %{type: :ephemeral, ttl: "1h"}

  @product_identity "You are Sigma, an Elixir-based AI coding agent."
  ...
  Passing `nil` uses Sigma's default stable product identity and operating policy.
  """
