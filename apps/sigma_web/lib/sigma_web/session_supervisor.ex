defmodule Sigma.Web.SessionSupervisor do
  @moduledoc """
  Per-session supervision subtree.

  Holds PermissionPolicy, Task.Supervisor, and Sigma.Agent under :one_for_all so
  ...
  def via(session_id) do
    {:via, Registry, {Sigma.Web.SessionRegistry, {session_id, :supervisor}}}
  end
  ...
  def init(opts) do
    ...
    policy_name = {:via, Registry, {Sigma.Web.SessionRegistry, {session_id, :policy}}}
    tasks_name = {:via, Registry, {Sigma.Web.SessionRegistry, {session_id, :tasks}}}
    agent_name = {:via, Registry, {Sigma.Web.SessionRegistry, {session_id, :agent}}}
