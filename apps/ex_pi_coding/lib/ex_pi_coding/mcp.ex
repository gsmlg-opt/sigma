defmodule PiCoding.MCP do
  ...
  `PiCoding.MCP.ClientSupervisor` and addressed through `PiCoding.MCP.Registry`.
  ...
  @registry PiCoding.MCP.Registry
  @supervisor PiCoding.MCP.ClientSupervisor

  @protocol_version "2025-06-18"
  @client_info %{"name" => "ex_pi", "version" => "0.1.0"}
